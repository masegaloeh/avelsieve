...
function avelsieve_generic_header() {
    ...
    if(stristr(basename($PHP_SELF), 'edit.php')) {
        // Edit page (edit.php)
        $js = array('prototype-1.6.0.2.js', 'avelsieve_common.js', 'avelsieve_edit.js', 'prototype-base-extensions.js', 'prototype-date-extensions.js', 'datepicker.js');
...
function junkmail_markspecial($box) {
    ...
    $parts = explode(str_replace('.', '\.',$delimiter), $box);
